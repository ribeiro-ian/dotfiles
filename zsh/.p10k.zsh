...
() {
  ...
  local dir_color=4
  [[ "$TERM_PROGRAM" == "ghostty" ]] && dir_color=255
  ...
  ####################[ yazi: yazi shell (https://github.com/sxyazi/yazi) ]#####################
  # Yazi shell color.
  typeset -g POWERLEVEL9K_YAZI_FOREGROUND=9
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_MIDNIGHT_COMMANDER_FOREGROUND=9
  # Custom icon.
  ...
  ###############################[ public_ip: public IP address ]###############################
  # Public IP color.
  typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND=245
  # Custom icon.
